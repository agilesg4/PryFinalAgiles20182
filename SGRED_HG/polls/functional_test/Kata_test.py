...
class Kata_test(TestCase):
    ...
    def test_detalle_actividad(self):
        self.browser.get('http://127.0.0.1:8000/polls/listar_actividades/1/')
        self.browser.implicitly_wait(3)
    ...
    def test_detalle_actividad_2(self):
        ...
        self.assertFalse(tipoact is None)
        idfase = self.browser.find_element_by_id("fase")
        self.assertFalse(idfase is None)
        ...
        self.assertFalse(fecha_inicio is None)
